        ...
        <html>
            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    ...
                    <p>
                        This is an XML sitemap, explicitly for <a href="https://dvrbs.camdenhistory.com" target="_blank">Camden, NJ History (dvrbs.camdenhistory.com)</a><br/>
                        There is a separate sitemap for the new <a href="https://camdenhistory.com" target="_blank">Camden History (camdenhistory.com)</a> site at
                        the <a href="https://camdenhistory.com/sitemap_index.xml" target="_blank">camdenhistory.com sitemap index</a>.
                    </p>
                </header>
            ...
            <div class="overflow-auto">
                <table class="w-100 f6 b--silver ba bw1" cellspacing="0">
                    <thead class="bg-silver">
                        <tr>
                            <th class="pa3 fw6 tl dark-gray" style="width:60px">Item</th>
